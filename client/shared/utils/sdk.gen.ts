...
import type { GetApiGameData, GetApiGameResponse, PostApiGameData, PostApiGameResponse, GetApiUserData, GetApiUserResponse, PostApiUserData, PostApiUserResponse, GetWsDartData, GetWsDartByGameIdData } from './types.gen';
 ...
 * Handles WebSocket connections for general game updates
 */
export const getWsDart = <ThrowOnError extends boolean = false>(options?: Options<GetWsDartData, ThrowOnError>) => {
...
/**
 * Handle game-specific WebSocket connections
 * Handles WebSocket connections for specific dart games
 */
export const getWsDartByGameId = <ThrowOnError extends boolean = false>(options: Options<GetWsDartByGameIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<unknown, unknown, ThrowOnError>({
        url: '/ws/dart/{gameId}',
        ...options
    });
